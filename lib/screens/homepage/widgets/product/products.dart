                                  ...
                                  children: [
                                    Text(
                                      Get.find<ProductController>()
                                          .orderSelectionToggle[index],
                                      style: TextStyle(
                                        fontSize: Get.find<ProductController>()
                                                    .selectedIndex
                                                    .value ==
                                                index
                                            ? 17
...
class ProductDatatableSource extends DataTableSource {
  ...
  DataRow? getRow(int index) {
    return DataRow(cells: [
      ...
      DataCell(Text(
          "ETB ${controller.flowerpotList.value[index].price.toString()}")),
      DataCell(InkWell(
        onTap: () {
          Get.dialog(
              AlertDialog(
                ...
                content: SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                          "are you deleting sale ${controller.flowerpotList.value[index].name}"),
