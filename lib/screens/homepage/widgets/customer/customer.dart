...
class Customer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() => Container(
        ...
        child: Get.find<CustomerController>().isLoading.value
            ? const Center(
            ...
            : SingleChildScrollView(
                ...
                ListTile(
                  ...
                  subtitle: const Text(
                    "registered fibermart Customer type",
                  ...
                  trailing: ElevatedButton.icon(
                      ...
                      label: Text(
                        "Add Customer TYpe",
                        style: TextStyle(color: Constants().backColor),
                      )),
                ),
                const SizedBox(
                  height: 25,
                  ...
                  child: GetBuilder<CustomerController>(
                    ...
                    builder: (controller) => SizedBox(
                      ...
                      child: PaginatedDataTable(
                          ...
                          source:
                              CustomerDatatableSource(controller: controller)),
                    ),
                  ),
              ...
              AlertDialog(
                ...
                content: SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                          "are you deleting customer ${controller.customerList.value[index].name}"),
                      Obx(() => controller.idDeleting.value
                          ? const Loading()
                          : const Text(""))
                    ],
                  ),
