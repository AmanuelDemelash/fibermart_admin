...
import 'package:fibermart_admin/models/bussiness_types.dart';
...
class AddNewCustomerForm extends StatelessWidget {
   AddNewCustomerForm({super.key});
    ...
    return Container(
      ...
      child:Column(
        ...
        children: [
          ...
          Obx(() =>Get.find<CustomerController>().isAddNewCustomer.value?
                ...
                child: ElevatedButton(
                  style: ElevatedButton.styleFrom(
                    ...
                    if(_idController.text.isEmpty || _nameController.text.isEmpty){
                      ...
                      CustomerTypes customer=CustomerTypes(name: _nameController.text, id:_idController.text);
                      Get.find<CustomerController>().addCustomer(customer);
                    }
